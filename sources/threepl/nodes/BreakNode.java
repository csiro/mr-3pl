...
/**
 * This implements a break statement.
 * This does nothing and is only used as a marker in the code tree.
 */
public final class BreakNode extends Node implements Constant {
    ...
    /**
     * There is no execution, however the 'BREAK' status
     * code is returned so that enclosing codes knows a break
     ...
     * @return  the EXECR.BREAK status value
     */
