...
\usepackage{inchmargins,fancyhdr,amsmath,graphicx,moreverb,listings,color,crtitle,calc,enumitem,xcolor,newverbs}
\usepackage{makeidx}
\usepackage{tocloft}
\usepackage{graphicx}
%\usepackage{pgf}
...
\input{immediate_statements}

\input{target_statements}
            
\input{memory_etc}

\input{inbuilt_modules}

\input{inbuilt_procedures}

\input{inbuilt_functions}
...
\input{running_compiler}

\input{serial_CPU_comm}
...
\input{regular_expressions}

\input{syntax}

\input{compiler_versions}
