...
public class XC3S extends XTDECode implements NetConstants {   
    ...
    public void MULREG (Net[] in, Net[] out, Net c, Net ce, Net r) {
        int     arrayformat = 2;
        Element e = new Element("MULT18X18SIO", Gtype.MULT18X18S);
        Net[]   one = new Net[1];
        one[0] = Net.HI;
        e.addInputArray("A", in, 18, Net.LO, arrayformat);
        e.addInputArray("B", one, 18, Net.LO, arrayformat);
        e.addOutputArray("P", out, arrayformat);
        e.addInput("C", c);
        e.addInput("CE", ce);
        e.addInput("R", r);
     ...
     * @param   loc is the soiurce file location
     */    
    ...
    public void regIntoDSP (TDE tde, TDEVar clk, TDEVar ce, TDEVar rst, TDEVar out) {
        ...
        params.set(0, "MULT18X18SIO");    // change to a registered multiplier
    ...
    */
    ...
    public void Mult (Net[] a, Net[] b, Net[] p) {
        int     arrayformat = 2;
        Element e = new Element("MULT18X18SIO", Gtype.MULT18X18);
