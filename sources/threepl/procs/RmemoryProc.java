...
/**
 * An inbuilt procedure to declare a registered output RAM block.
 * This has 1, 4 or 5 (or more) input arguments and no output arguments.
 *
 * <p>The 1st input argument is the memory mode variable.
 *
 * <p>The 2nd input argument is the number of ports.
 *
 * <p>The 3rd input argument is the data type.
 *
 * <p>The 4th input argument is the address type.
 *
 * <p>The 5th input argument is an optional immediate array of initialisation
 * values.
 *
 ...
 * may be appended.
 */
public class RmemoryProc extends InbuiltProc implements Constant, TDEConstants {

    /**
     * Construct the inbuilt procedure rmemory().
    ...
    /**
     * Execute the memory variable declaration procedure rmemory().
