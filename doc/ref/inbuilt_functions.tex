...
\chapter{Inbuilt Functions}
    ...
    \section{cmemoryread - read a combinatorial output memory}\label{sec:ifcmemoryread}
        ...
        {\bf Description:} \\
        {\em mem} is the memory mode variable identifier.
    ...
    \section{componentpointer - get a pointer to a variable component}\label{sec:ifcomponentpointer}
        ...
        This function is intended for assigning or evaluating value, static or
        queue mode variable fields or array members from outside the FPGA, e.g.
        from an attached CPU. A request to assign to a variable field or array
        member can be transmitted to the FPGA using a simple integer index to
        select the component to be assigned.
