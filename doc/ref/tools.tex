...
\chapter{Miscellaneous tools}\label{ch:misctools}
    ...
    \section{info2c/}
        ...
        Generate CPU/FPGA zynq interface functions for C from the 3PL
    ...
    \section{serial/}
        ...
        \subsection{cpu\_serial.c/, cpu\_serial.h}
            ...
            As well as the open and close procedures listed below this file
            defines necessary low-level CPU/FPGA interface communications functions.
            These functions are called from the interface code in the C include file
            generated by {\bf info2c}.
