...
\label{chap:lmxilcpulib}
    ...
    \subsection{class library modules}
        ...
        \subsubsection{CPU\_API.dma\_read - DMA transfer to FPGA from CPU}\label{sec:lpcpudmar}
            ...
            argument, {\bf address}, is valid - {\bf burstlen} and {\bf bus}
            must not be given arguments. {\bf This address is relative to a base
            address} set by calling {\bf set\_dma\_address()}
            \autorefph{ch:tools_c_serial}.
