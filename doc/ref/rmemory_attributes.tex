        ...
        \hline
        init       & 3PL       &                      & memory initial value                    \\
        init0      & 3PL       &                      & output port A initial value                    \\
        init1      & 3PL       &                      & output port B initial value                    \\
        ...
        {\bf init0} and {\bf init1} set initial values for output latch A (port
        0)and output latch B (port 1). Any previous initial values will be
        overwritten. {\bf init1} is only valid for a 2-port memory. Neither of
        these is valid for CLB memory (cmemory()).
