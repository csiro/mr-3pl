...
//   on Thu, 30 Sep 2021 21:40:25 +1000

#ifndef __fpga__prog_h__
#define __fpga__prog_h__


// interface "WW" in space "reg" (bus "serial")
...
// interface "WWW" in space "reg" (bus "serial")
...
// interface "WQ" in space "reg" (bus "serial")
...
// interface "WQ_avail" in space "reg" (bus "serial")
...
// interface "WQ_avail_thresh" in space "reg" (bus "serial")
...
// interface "RR" in space "reg" (bus "serial")
...
fpga_RR_read() {
    ...
    if ((v & 0x400000000) != 0)
        v |= 0xfffffff800000000L;
    return(v);
}

// interface "MW" in space "reg" (bus "serial")
...
// interface "R" in space "reg" (bus "serial")
...
// interface "W" in space "reg" (bus "serial")
...
// interface "MR" in space "reg" (bus "serial")
typedef uint16_t fpga_MR_t;
const unsigned fpga_MR_addr = 8;
static fpga_MR_t
...
// interface "RRR" in space "reg" (bus "serial")
...
// interface "RQ" in space "reg" (bus "serial")
...
// interface "RQ_avail" in space "reg" (bus "serial")
...
// interface "RQ_avail_thresh" in space "reg" (bus "serial")
