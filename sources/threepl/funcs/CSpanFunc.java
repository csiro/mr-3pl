 ...
 * whose characters do not appear in a character set.
 ...
 */
public class CSpanFunc extends InbuiltFunc implements Constant {
    ...
    public Val getVal (NodeList args) {
        ...
        if (args.size() != 2)
            throw new ExEx("cspan() must have 2 arguments", loc);
