...
\chapter{Introduction}
    ...
    \section{The 3PL language}
        ...
        This document describes a {\em dataflow}\footnote{Dataflow was a name
        ...
        Programming Language" (the name was suggested by Alen Yokhanis).
        ...
        only when modules or groups of modules are not in a state to accept
        them.

        Data cannot be assumed to be contiguous in a pipeline.
    ...
    \section{Current version}
        ...
        The current version of 3PL is {\bf 11.6}. It requires Java 1.6 or
    ...
    \section{Acknowledgements}
        ...
        Melbourne. The group is now called High Speed Instrumentation and is in
        CSIRO Mineral Resources, Clayton, Melbourne.

        Paul Dunn conceived the language and Paul and Andrew Bainbridge-Smith
        ...
        proved to have serious shortcomings and was never completed. Paul Dunn
        redesigned the language and re-implemented the compiler from scratch.
        This benefited greatly from the experience of the first attempt.
        ...
        throughout and has contributed considerable 3PL library code.
