    ...
    \section{Types}\label{sec:types}
        ...
        \subsection{arrays}
            ...
            \subsubsection{creating arrays}   
                ...
                \index{array!undimensioned}
                \index{dimensions!missing}
                Where the mode keyword is not provided as the second argument,
                immediate mode is assumed, as in the first example above.
                ...
                Arrays may be initialised via a fourth argument, e.g.
                \begin{lstlisting}[gobble=16, language=threepl]
                   var(sum, static, "[10]int:16", {21, 17, 45});
                \end{lstlisting}
                which will give the first three memebers of the array initial
                values. Initialisation values left to right are assigned in
                increasing subscript order. The initialisation compound value
                can also provide default dimension(s), e.g.
                \begin{lstlisting}[gobble=16, language=threepl]
                   var(sum, static, "[]int:16", {21, 17, 45});
                \end{lstlisting}
                will create an array whose dimension is 3.
