...
\chapter{Introduction}
    ...
    This software was developed within a machine vision research group in
    CSIRO (Commonwealth Scientific and Industrial Research Organisation), an
    Australian Federal Government research laboratory. It was developed and
    used successfully over two decades to implement machine vision
    algorithms in FPGAs and to provide high-speed data processing in
